...
- (void)downloadWithURL:(NSURL *)URL {
    ...
    NSMutableURLRequest *mutableRequest = [[NSURLRequest requestWithURL:URL] mutableCopy];
    [mutableRequest setValue:OSSREFERER forHTTPHeaderField:OSSREFERERKEY];
    _downloadTask = [session downloadTaskWithRequest:mutableRequest];
...
- (void)setVideoURL:(NSURL *)videoURL{
    ...
    [headers setObject:OSSREFERER forKey:OSSREFERERKEY];
    self.videoAVAsset = [AVURLAsset URLAssetWithURL:_videoURL options:@{@"AVURLAssetHTTPHeaderFieldsKey" : headers}];
}
