...
- (void)setImageURL:(NSURL *)imageURL {
    if ([imageURL isKindOfClass:NSString.class]) {
        imageURL = [NSURL URLWithString:[BaseTool showNormalImage:(NSString *)imageURL]];
    }else if ([imageURL isKindOfClass:NSURL.class] && [imageURL.absoluteString containsString:@"?"]) {
        NSString *urlStr = imageURL.absoluteString;
        imageURL = [NSURL URLWithString:[BaseTool showNormalImage:urlStr]];
    }
    _imageURL = imageURL;
}
